...
The equation $3x=1$ represents a line, as does $x+2y=3$. Figure \ref{fig:lineintersectexample} shows these lines:
\begin{figure}[H]
\centering
Line $3x=1$
Line $x+2y=3$}
 (sol) at $(\frac{1}{3}, \frac{4}{3})$
  at $(1, \frac{5}{3})$ $(?,?)$

\caption{Visual depiction of two intersecting lines from system \eqref{eq:system1}.}
\label{fig:lineintersectexample}
\end{figure}
